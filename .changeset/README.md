...
```markdown
---
"atproto2elasticsearch": patch|minor|major
---
...
**Examples:**
- `.changeset/fix-firehose-reconnect.md` - Fix firehose reconnect handling (patch)
- `.changeset/add-ml-pipeline.md` - Add optional ML pipeline for ingest (minor)
- `.changeset/node-22-upgrade.md` - Require Node.js 22+ and update release pipeline (major)
